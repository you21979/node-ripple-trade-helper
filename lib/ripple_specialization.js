...
var tradeHistory = exports.tradeHistory = function(api, address){
    return api.accountTransactions(address, {
        limit : 1000
    }).then(function(res){
        var list = [];
        res.transactions.forEach(function(txn){
            var f = getTransaction(txn.tx.TransactionType);
            var o = f(res.account, txn).shift();
            if(o){
                list.push(o);
            }
        })
