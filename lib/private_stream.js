...
var createPrivateStream = module.exports = function(myaddress, secret, issuer, callbacks){
    return new PrivateStream(issuer, myaddress, secret, callbacks);
}
...
var PrivateStream = function(issuer, address, secret, callbacks){
    PublicStream.call(this, issuer, callbacks);
