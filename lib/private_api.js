...
PrivateApi.prototype.balance = function(){
    ...
    return RipplePromise.defaultPromiseConnect(function(remote){
        return self.promise().all([
            RipplePromise.accountLines( remote, self.address ),
            RipplePromise.accountBalance( remote, self.address )
...
PrivateApi.prototype.trust = function(currency, limit){
    ...
    var self = this;
    return RipplePromise.defaultPromiseConnect(function(remote){
        return RipplePromise.accountLines(remote, self.address).then(function(res){
